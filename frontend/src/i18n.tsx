...
const messages: Record<Language, Record<string, string>> = {
  en: {
    ...
    'sidebar.fulfillment': 'Fulfillment',
    ...
    'fulfillment.subtitle': 'Source on 1688, list on Douyin, then auto-fulfill orders',
    'fulfillment.tabListings': 'Sourced Listings',
    'fulfillment.tabOrders': 'Orders',
    'fulfillment.sourceAndList': 'Source & List',
    'fulfillment.sourcing': 'Sourcing...',
    'fulfillment.newSourcing': 'New Sourcing',
    'fulfillment.formTitle': 'Source a product & list it',
    'fulfillment.fieldTitle': 'Product Title',
    'fulfillment.fieldTitlePlaceholder': 'e.g. Ice silk cooling scarf',
    'fulfillment.fieldCategory': 'Category',
    'fulfillment.fieldImage': 'Reference Image URL',
    'fulfillment.fieldDescription': 'Description',
    'fulfillment.autoPublish': 'Auto-publish after review',
    'fulfillment.submit': 'Start Sourcing',
    'fulfillment.cancel': 'Cancel',
    'fulfillment.product': 'Product',
    'fulfillment.supplier': 'Supplier',
    'fulfillment.matchScore': 'Match',
    'fulfillment.wholesale': 'Wholesale',
    'fulfillment.landedCost': 'Landed Cost',
    'fulfillment.sellPrice': 'Sell Price',
    'fulfillment.margin': 'Margin',
    'fulfillment.status': 'Status',
    'fulfillment.noListings': 'No sourced listings yet',
    'fulfillment.orderNo': 'Order',
    'fulfillment.qty': 'Qty',
    'fulfillment.paid': 'Paid',
    'fulfillment.tracking': 'Tracking',
    'fulfillment.alibabaOrder': '1688 Order',
    'fulfillment.actions': 'Actions',
    'fulfillment.fulfill': 'Fulfill',
    'fulfillment.fulfilling': 'Fulfilling...',
    'fulfillment.noOrders': 'No orders yet',
    'fulfillment.statListed': 'Listed',
    'fulfillment.statMatching': 'Sourcing',
    'fulfillment.statOrders': 'Total Orders',
    'fulfillment.statShipped': 'Shipped/Delivered',
    ...
    'status.listing_failed': 'Listing Failed',
    'status.received': 'Received',
    'status.sourcing': 'Sourcing',
    'status.sourced': 'Sourced',
    'status.shipped': 'Shipped',
    'status.delivered': 'Delivered',
    'status.fulfill_failed': 'Fulfill Failed',
  ...
  zh: {
    ...
    'fulfillment.subtitle': '1688 同源找货 → 上架抖店 → 订单自动履约与物流跟踪',
    'fulfillment.tabListings': '已上架/选品',
    'fulfillment.tabOrders': '订单',
    'fulfillment.sourceAndList': '选品上架',
    'fulfillment.sourcing': '处理中...',
    'fulfillment.newSourcing': '新建选品',
    'fulfillment.formTitle': '选品并上架',
    'fulfillment.fieldTitle': '商品标题',
    'fulfillment.fieldTitlePlaceholder': '例如：冰丝防晒凉感围巾',
    'fulfillment.fieldCategory': '类目',
    'fulfillment.fieldImage': '参考图片 URL',
    'fulfillment.fieldDescription': '描述',
    'fulfillment.autoPublish': '审核通过后自动上架',
    'fulfillment.submit': '开始选品',
    'fulfillment.cancel': '取消',
    'fulfillment.product': '商品',
    'fulfillment.supplier': '供应商',
    'fulfillment.matchScore': '匹配度',
    'fulfillment.wholesale': '进货价',
    'fulfillment.landedCost': '到手成本',
    'fulfillment.sellPrice': '售价',
    'fulfillment.margin': '毛利率',
    'fulfillment.status': '状态',
    'fulfillment.noListings': '暂无选品/上架记录',
    'fulfillment.orderNo': '订单',
    'fulfillment.qty': '数量',
    'fulfillment.paid': '实付',
    'fulfillment.tracking': '运单号',
    'fulfillment.alibabaOrder': '1688 订单',
    'fulfillment.actions': '操作',
    'fulfillment.fulfill': '履约下单',
    'fulfillment.fulfilling': '下单中...',
    'fulfillment.noOrders': '暂无订单',
    'fulfillment.statListed': '已上架',
    'fulfillment.statMatching': '选品中',
    'fulfillment.statOrders': '订单总数',
    'fulfillment.statShipped': '已发货/签收',
    ...
    'status.matching': '匹配中',
    'status.matched': '已匹配',
    'status.no_source': '无同源货品',
    'status.listing': '上架中',
    'status.listed': '已上架',
    'status.listing_failed': '上架失败',
    'status.received': '已接单',
    'status.sourcing': '采购中',
    'status.sourced': '已采购',
    'status.shipped': '已发货',
    'status.delivered': '已签收',
    'status.fulfill_failed': '履约失败',
