...
v1_router.include_router(orchestration_router, prefix="/orchestration", tags=["orchestration"])
v1_router.include_router(runtime_router, prefix="/runtime", tags=["runtime"])
...
v1_router.include_router(tools_router, prefix="/tools", tags=["tools"])
